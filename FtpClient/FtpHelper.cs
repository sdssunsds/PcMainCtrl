...
namespace PcMainCtrl.FtpClient
{
    public class FtpHelper
    {
        ...
        public static FtpHelper GetInstance(string ipAddr, string port, string userName, string password)
        {
            return instance ?? (instance = new FtpHelper(ipAddr, port, userName, password));
        }
